...
public class DienThoaiAdapter extends BaseAdapter
{
    ...
    public DienThoaiAdapter(Context context, ArrayList<SanPham> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            viewHolder.textView1 = convertView.findViewById(R.id.textViewDienThoai);
            viewHolder.textView2 = convertView.findViewById(R.id.textViewGiaDienThoai);
            viewHolder.textView3 = convertView.findViewById(R.id.textViewMoTaDienThoai);
            viewHolder.imageView1 = convertView.findViewById(R.id.imageViewDienThoai);
